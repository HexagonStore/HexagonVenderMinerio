...
public enum TranslateItems {
    ...
    REDSTONE_ORE__0("Redstone"),
    GLOWING_REDSTONE_ORE__0("Redstone"),
    ...
    TranslateItems(String name) {
        this.name = name;
    }

    public static TranslateItems valueOf(ItemStack item) {
        try {
    ...
    public static TranslateItems valueOf(String name, short durability) {
        try {
    ...
    public static TranslateItems valueOf(String name, byte data) {
        try {
    ...
    public static TranslateItems valueOf(Material material, byte data) {
        try {
    ...
    public static TranslateItems valueOf(Material material) {
        return valueOf(material.name() + "__0");
    }

    public static TranslateItems valueOf(Item item) {
        return valueOf(item.getItemStack());
    }

    public static TranslateItems valueOf(Block block) {
